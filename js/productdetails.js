...
import { LoadingBar } from "../libs/threejs/LoadingBar.js";
...
class Prod {
    constructor() {
        ...
        this.colors = [{
            texture: '../assets/models/wood_.jpg',
            size: [2, 2, 2],
            shininess: 60
        }, {
            texture: '../assets/models/denim_.jpg',
            size: [2, 2, 2],
            shininess: 60
        }, {
            color: '131417'
    ...
    setEnvironment() {
        ...
        loader.load(
            "../assets/models/venice_sunset_1k.hdr",
            (texture) => {
    ...
    loadGLTF(id, lscale) {
        ...
        loader.load(
            ...
            function(gltf) {
                ...
                let txt = new THREE.TextureLoader().load('../assets/models/denim_.jpg');
